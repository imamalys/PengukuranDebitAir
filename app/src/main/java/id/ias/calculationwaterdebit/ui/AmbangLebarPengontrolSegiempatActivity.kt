...
class AmbangLebarPengontrolSegiempatActivity : AppCompatActivity() {
    ...
    private fun setAction() {
        mBinding.btnNext.setOnClickListener {
            ...
            alps.putExtra("b", String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.lebarAmbang))
            startActivity(alps)
            finish()
        }
    }
    ...
    private fun setVariable() {
        if (alpsActivityViewModel.alpsData.id != null) {
            ...
            LegacyTableView.insertLegacyContent(
                String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.lebarAmbang),
                String.format(Locale.ENGLISH,"%.3f", alpsActivityViewModel.alpsData.lebarDasar),
                String.format(Locale.ENGLISH,"%.3f", alpsActivityViewModel.alpsData.panjangAmbang),
                String.format(Locale.ENGLISH,"%.3f", alpsActivityViewModel.alpsData.tinggiAmbang),
                String.format(Locale.ENGLISH,"%.3f", alpsActivityViewModel.alpsData.tinggiDiatasAmbang),
                String.format(Locale.ENGLISH,"%.3f", alpsActivityViewModel.alpsData.tinggiDibawahAmbang),
                String.format(Locale.ENGLISH,"%.3f", alpsActivityViewModel.alpsData.lebarAtas))
        ...
        pengambilanDataViewModel.pengambilanDataById.observe(this, {
            if (isInit) {
                ...
                for (i in it.indices) {
                    ...
                    val l: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.panjangAmbang)
    ...
    private fun setCv() {
        ...
        for (i in cd.indices) {
            val bc: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.lebarAmbang)
            val pM: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.tinggiDiatasAmbang)
            val aQuote: String = String.format(Locale.ENGLISH, "%.3f", bc.toFloat() * pM.toFloat())
            val capitalB1: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.lebarDasar)
            val m: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.tinggiDiatasAmbang)
            val p: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.tinggiAmbang)
            val w: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.tinggiDibawahAmbang)
            val b1: String = String.format(Locale.ENGLISH, "%.3f", alpsActivityViewModel.alpsData.lebarAtas)
