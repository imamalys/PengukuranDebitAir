...
import id.ias.calculationwaterdebit.database.viewmodel.KoefisiensiAmbangLebarViewModel

class DBKoefisiensiAmbangLebarSegiempat {
    companion object {
        fun insertKoefisiensiAmbangLebarSegiempat(koefisiensiAmbangLebarDao: KoefisiensiAmbangLebarViewModel, listener: InsertSuccess) {
            ...
            koefisiensiAmbangLebarDao.insert(koefisiensi)
            listener.ambangLebarSegiempat(0)
        }

        interface InsertSuccess {
            fun ambangLebarSegiempat(count: Int)
        }
    }
}